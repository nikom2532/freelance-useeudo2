...
<body>
			<div id="head">
                  <div class="headleft">
            			<a href="#" title="useesdo.com"> <img src="images/logo.png" border="0" alt="UseeUdo" height="98"></a>
                   </div>
                    <div class="headright">
                    		<div id="main_menu">
                                <ul>
                                        <li><a href="#">หน้าหลัก</a></li>
                                        <li><a href="#">สูตรอาหาร</a></li>
            ...
            <div id="slides">
                    		 <!-- -----------------------------slider----------------------------------- -->
                                <div id="wowslider-container1">
                                    <div class="ws_images">
                                            <a href="#">
                                                <img src="images/slide1.png" alt="useeudo" title="" id="wows0"/>
                                            </a>
                                            <a href="#">
                                                <img src="images/slide2.png" alt="useeudo" title="" id="wows1"/>
                                            </a>
                                            <a href="#">
                                                <img src="images/slide3.png" alt="useeudo" title="" id="wows2"/>
                                            </a>
                                            <a href="#">
                                                <img src="images/slide4.png" alt="useeudo" title=" " id="wows3"/>
                                            </a>
                                    </div>
	...
	<div id="wrapper">
            ...
            <div id="content">
            		<div class="content-left">
                        	<a href="#"><img src="images/bg-update.png" border="0"></a><br>
                            <img src="images/tomato.png" border="0">
...
และสิ่งที่เราใช้ใส่ลงไปในอาหารเหล่านี้ นักวิชาการเรียกว่า วัตถุเจือปนอาหาร หรือ Food Additives นี่เอง ที่จะช่วยให้คุณ ได้อาหารจานสุขภาพสำหรับทุกคนในครอบครัว ที่ทำได้แสนจะง่าย ในครัวเล็กๆ ของเราที่บ้าน แล้วยังสามารถช่วยประหยัดต้นทุนในการทำอาหารและขนมเลิศรสหลากหลายประเภท ได้อีกจำนวนหนึ่งด้วย
    ...
    <div id="wrapper-footer">
    	<div class="adsvertising">
    	 <p>
                        		<img src="images/adsvertising.png" >
                        </p>
      </div>                  
     <!-- <div id="footer">
      	<p>&nbsp;</p>
